...
export default function RegisterForm({ setMsg }: { setMsg: Function }) {
  ...
  return (
    <form action={dispatch} className='flex flex-col z-10'>
      ...
      <Input id='username' name='username' className={clsx({ 'border-red-600': state.errors?.username }, 'mb-3')} />
      {
      ...
      <Input id='realname' name='realname' className={clsx({ 'border-red-600': state.errors?.realname }, 'mb-3')} />
      {
      ...
      <Input id='email' name='email' className={clsx({ 'border-red-600': state.errors?.email }, 'mb-3')} />
      {
        state.errors?.email && (
          <div aria-live='polite' aria-atomic>
      ...
      <InputOTP className='mb-3' id='passport' name='passport' pattern={Pattern} maxLength={9} render={({ slots }) => (
        <>
          <InputOTPGroup>
      ...
      <Input id='pass1' name='pass1' type='password' className={clsx({ 'border-red-600': state.errors?.pass1 }, 'mb-3')} />
      {
        state.errors?.pass1 && (
          <div aria-live='polite' aria-atomic>
      ...
      <Input id='pass2' name='pass2' type='password' className={clsx({ 'border-red-600': state.errors?.pass2 }, 'mb-3')} />
      {
        state.errors?.pass2 && (
          <div aria-live='polite' aria-atomic>
